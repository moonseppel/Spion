...
public class LmGameHibernateBean {
    ...
    public LmGameHibernateBean(LmGamePage gamePage) {
        getValuesFromGame(gamePage);
    }
    ...
    private void getValuesFromGame(LmGamePage gamePage) {

        gameId = gamePage.getGameId();
        seasonNumber = gamePage.getSeasonNumber();

        hasExtraTime = gamePage.hasExtraTime();
        hasPenaltyShooting = gamePage.hasPenyltyShooting();

        homeTeamName = gamePage.getHomeTeamName();
        awayTeamName = gamePage.getAwayTeamName();
        endResultHome = gamePage.getEndResult().getHome();
        endResultAway = gamePage.getEndResult().getAway();
        resultFirstHalfHome = gamePage.getResults().firstHalf.getHome();
        resultFirstHalfAway = gamePage.getResults().firstHalf.getAway();
        resultSecondHalfHome = gamePage.getResults().secondHalf.getHome();
        resultSecondHalfAway = gamePage.getResults().secondHalf.getAway();
        resultExtraTimeHome = gamePage.getResults().extraTime.getHome();
        resultExtraTimeAway = gamePage.getResults().extraTime.getAway();
        resultPenaltyShootingHome = gamePage.getResults().penalityShooting.getHome();
        resultPenaltyShootingAway = gamePage.getResults().penalityShooting.getAway();
        formationFirstHalfHome = gamePage.getHomeFormations().firstHalf;
        formationSecondHalfHome = gamePage.getHomeFormations().secondHalf;
        formationExtraTimeHome = gamePage.getHomeFormations().extraTime;
        formationFirstHalfAway = gamePage.getAwayFormations().firstHalf;
        formationSecondHalfAway = gamePage.getAwayFormations().secondHalf;
        formationExtraTimeAway = gamePage.getAwayFormations().extraTime;
        tacticFirstHalfHome = gamePage.getHomeTactics().firstHalf;
        tacticSecondHalfHome = gamePage.getHomeTactics().secondHalf;
        tacticExtraTimeHome = gamePage.getHomeTactics().extraTime;
        tacticFirstHalfAway = gamePage.getAwayTactics().firstHalf;
        tacticSecondHalfAway = gamePage.getAwayTactics().secondHalf;
        tacticExtraTimeAway = gamePage.getAwayTactics().extraTime;
        strengthBeginOfFirstHalfHome = gamePage.getStrengthsBeginOfHalfs().firstHalf.getHome();
        strengthBeginOfFirstHalfAway = gamePage.getStrengthsBeginOfHalfs().firstHalf.getAway();
        strengthBeginOfSecondHalfHome = gamePage.getStrengthsBeginOfHalfs().secondHalf.getHome();
        strengthBeginOfSecondHalfAway = gamePage.getStrengthsBeginOfHalfs().secondHalf.getAway();
        strengthBeginOfExtraTimeHome = gamePage.getStrengthsBeginOfHalfs().extraTime.getHome();
        strengthBeginOfExtraTimeAway = gamePage.getStrengthsBeginOfHalfs().extraTime.getAway();
        strengthAverageOfFirstHalfHome = gamePage.getStrengthsAverageOfHalfs().firstHalf.getHome();
        strengthAverageOfFirstHalfAway = gamePage.getStrengthsAverageOfHalfs().firstHalf.getAway();
        strengthAverageOfSecondHalfHome = gamePage.getStrengthsAverageOfHalfs().secondHalf.getHome();
        strengthAverageOfSecondHalfAway = gamePage.getStrengthsAverageOfHalfs().secondHalf.getAway();
        strengthAverageOfExtraTimeHome = gamePage.getStrengthsAverageOfHalfs().extraTime.getHome();
        strengthAverageOfExtraTimeAway = gamePage.getStrengthsAverageOfHalfs().extraTime.getAway();
        strengthEndOfFirstHalfHome = gamePage.getStrengthsEndOfHalfs().firstHalf.getHome();
        strengthEndOfFirstHalfAway = gamePage.getStrengthsEndOfHalfs().firstHalf.getAway();
        strengthEndOfSecondHalfHome = gamePage.getStrengthsEndOfHalfs().secondHalf.getHome();
        strengthEndOfSecondHalfAway = gamePage.getStrengthsEndOfHalfs().secondHalf.getAway();
        strengthEndOfExtraTimeHome = gamePage.getStrengthsEndOfHalfs().extraTime.getHome();
        strengthEndOfExtraTimeAway = gamePage.getStrengthsEndOfHalfs().extraTime.getAway();
    }
